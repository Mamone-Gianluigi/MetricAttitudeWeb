		...
		//  String filePath = "C:\\Users\\Fabio\\Desktop\\FileInUpload"+File.separatorChar;
			...
			for(File x: files){
				if(x.isDirectory()){
					...
					String nome2="'"+nome+"'";
					out.print("<div id=\"abc\"><li style=\"width:250px\"><a>"+cont+"<span>"+nome+"</span></a></li>&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp<button style=\"border: 2px solid #fff; border-radius: .7em;\" onclick=\"grafo("+nome2+")\">Grafo</button>&nbsp &nbsp &nbsp &nbsp &nbsp<button style=\"border: 2px solid #fff; border-radius: .7em;\" onclick=\"elimina("+nome2+")\">Elimina</button><br><br/></div><br>");
					cont++;
				}
			}
			}
...
function grafo(nome){
	window.location.href='/upload/output.jsp?name='+nome+'&type=layered'
}
